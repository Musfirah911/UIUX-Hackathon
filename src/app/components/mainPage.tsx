export default function MainPage(){
    ...
    <div className="ml-8 lg:ml-16 lg:items-center justify-start w-full lg:w-1/2 pl-4 lg:pl-40">
        <p className="text-[32px] lg:text-[56px] mt-16 lg:mt-64">Rocket single</p>
        <p className="text-[28px] lg:text-[52px] mt-[-10px] lg:mt-[-18px]">seater</p>
    ...
    <img
        ...
        className="h-[300px] w-auto lg:h-[750px] lg:w-[700px] lg:pr-24 mt-4 lg:mt-0"
    />
</div>
<div className="Banner2 flex flex-wrap bg-[#FAF4F4] h-auto lg:h-screen w-full">
    <div className="flex flex-wrap justify-center lg:justify-start mt-10 lg:mt-20">
        {/* Part 1 */}
        <div className="part1 w-full lg:w-[605px] h-auto lg:h-[562px] mt-7 lg:ml-28 pb-10">
            <img
                src="/images/6.png"
                alt="Table"
...
<div className="Banner3 justify-items-center bg-white p-4">
    ...
    <div className="BasicDiv flex flex-wrap justify-center lg:justify-start lg:pl-24 mt-8">
        ...
        <div className="m-4 w-[160px] lg:w-[200px]">
            <img src="/images/8.png" alt="Trenton modular sofa_3" className="w-full h-auto" />
            <p className="text-[14px] lg:text-[17px] text-left mt-2">
                Trenton modular sofa_3
            </p>
            <p className="text-[20px] lg:text-[28px] mt-2">
                Rs. 25,000.00
            </p>
        </div>
        {/* Item 2 */}
        <div className="m-4 w-[160px] lg:w-[200px]">
            <img src="/images/9.png" alt="Granite dining table with dining chair" className="w-full h-auto" />
            <p className="text-[14px] lg:text-[17px] text-left mt-2">
        ...
        {/* Item 3 */}
        <div className="m-4 w-[160px] lg:w-[200px]">
            <img src="/images/10.png" alt="Outdoor bar table and stool" className="w-full h-auto" />
            <p className="text-[14px] lg:text-[17px] text-left mt-2">
        ...
        {/* Item 4 */}
        <div className="m-4 w-[160px] lg:w-[200px]">
            <img src="/images/11.png" alt="Plain console with teak mirror" className="w-full h-auto" />
            <p className="text-[14px] lg:text-[17px] text-left mt-2">
...
<div className="Banner5 bg-[#FFFFFF] text-center p-4">
    ...
    <div className="BasicDiv flex flex-wrap justify-center mt-14 gap-6">
        ...
        <div className="justify-items-center m-2 max-w-[300px]">
            ...
            <p className="mt-4 text-[16px]">Going all-in with millennial design</p>
            <button className="mt-4 text-[14px]">
                Read More
                <div className="border border-black mt-2 opacity-30"></div>
            </button>
            <img src="/images/16.png" alt="vector" className="h-[20px] w-[150px] mt-6 mx-auto" />
        </div>
...
<div className="Banner6 bg-[url('/images/17.png')] bg-cover bg-center h-[450px] text-center flex flex-col items-center justify-center">
    <p className="text-[30px] md:text-[50px] font-extrabold">Our Instagram</p>
    <p className="text-[16px] md:text-[20px] mt-2 md:mt-4">Follow our store on Instagram</p>
